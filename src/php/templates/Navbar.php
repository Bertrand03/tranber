...
$signUpdateProfileUrl  = $siteUrl.'update-profile';
...
<?php if ($clientLogged): ?>
			...
			<li class="elm_Menu_Item elm_Menu_Item-navbar">
				<a href="<?= $signUpdateProfileUrl ?>" class="atm_Link atm_Link-menu atm_Link-navbar atm_Link-navbarMenu">Update Profile</a>
			</li>
<?php else: ?>
			<li class="elm_Menu_Item elm_Menu_Item-navbar">
